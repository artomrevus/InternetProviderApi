...
[Route("[controller]")]
[ApiController]
public class InternetTariffStatusController(IInternetTariffStatusService service, IMapper<IInternetTariffStatus, InternetTariffStatusRequestDto, InternetTariffStatusResponseDto> mapper) : ControllerBase
{
    ...
    [HttpPost]
    [Authorize(Roles = "Admin")]
    public async Task<IActionResult> Add([FromBody] InternetTariffStatusRequestDto dto)
    {
        try
        {
    ...
    [Route("{id:int:min(1)}")]
    [Authorize(Roles = "Admin")]
    public async Task<IActionResult> Update([FromRoute] int id, [FromBody] InternetTariffStatusRequestDto dto)
    {
        try
        {
